...
class TestDocumentGeneration(IntegrationTestCase):
    ...
    def test_get_generation_context(self):
        ...
        self.assertEqual(ICriteria(self.folder).get('c0').widget,
                          u'sorting')
        ...
        gen_context = self.view._get_generation_context(self.helper, self.dashboardtemplate)
        self.assertEqual(len(gen_context['uids']), 2)
        self.assertEqual(len(gen_context['brains']), 2)
    ...
    def test_get_generation_context_filtered_query(self):
        ...
        self.assertEqual(ICriteria(self.folder).get('c2').index,
                          u'SearchableText')
    ...
    def test_get_generation_context_filtered_uids(self):
        ...
        gen_context = self.view._get_generation_context(self.helper, self.dashboardtemplate)
        self.assertEqual(len(gen_context['uids']), 1)
        self.assertEqual(len(gen_context['brains']), 1)
    ...
    def test_generation_context_with_use_objects(self):
        ...
        self.assertEqual(gen_context.get('objects'), None)
